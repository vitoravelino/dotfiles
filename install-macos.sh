...
# cli
brew install fzf gnupg pinentry-mac htop bat wget ripgrep jq eza btop neofetch grep cloudflared watch btop neovim fd lazygit wget gnu-sed watchman tldr dust
